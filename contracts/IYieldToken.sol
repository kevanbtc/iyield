 ...
 * 
 * TRADEMARK: iYield™ for tokenized insurance-backed yield notes
 */
contract IYieldToken is ERC20, ERC20Pausable, AccessControl, ReentrancyGuard {
    ...
    function addPolicyBacking(
        ...
        // Verify oracle attestation is fresh
    ...
    /**
     * @dev Calculate and update Net Asset Value
     */
    ...
    function _beforeTokenTransfer(
        ...
        // Full compliance check for transfers
